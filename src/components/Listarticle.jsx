...
const Listarticle = () => {
  ...
  const fetchPosts = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        // Assuming your API returns total posts count and total pages
  ...
  useEffect(() => {
    if (isSubCategoriesLoaded && editingPost && editingPost.sub_category) {
      setSelectedSub(editingPost.sub_category.id?.toString() || "");
    }
  ...
  const handleEdit = (post) => {
    ...
    setSelectedMain(post.main_category?.id?.toString() || "");
    setSelectedSub("");
  };
